...
export function CreateMentorModal({ open, onOpenChange, onSubmit }: CreateMentorModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{t('mentors.createTitle')}</DialogTitle>
          <DialogDescription>
            {t('mentors.createDescription')}
          </DialogDescription>
        </DialogHeader>
